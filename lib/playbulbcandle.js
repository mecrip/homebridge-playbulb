...
module.exports = function(accessory, characteristic, service) {
	Accessory = accessory;
	Characteristic = characteristic;
	Service = service;
	return PlaybulbCandle;
};
var EFFECTS_TEMPLATE = "00<rgb>04000a00";
var EFFECTS_HANDLE = 0x0014;

function PlaybulbCandle(log, name, address) {
	this.log = log;
	this.name = name;
...
PlaybulbAccessory.prototype.disconnect = function(error) {
	if(error){
