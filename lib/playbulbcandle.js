...
PlaybulbCandle.prototype.connect = function(bulb, homebridgeAcc) {
    ...
    var service=homebridgeAcc.getService(Service.Lightbulb);
    if (service==null){
        service=new Service.Lightbulb(this.config.name,"Light");
    ...
    service.getCharacteristic(Characteristic.Brightness).on('get', this.getBrightness.bind(this));
    service.getCharacteristic(Characteristic.Brightness).on('set', this.setBrightness.bind(this));
    service.getCharacteristic(Characteristic.Hue).on('get', this.getHue.bind(this));
    service.getCharacteristic(Characteristic.Hue).on('set', this.setHue.bind(this));
    service.getCharacteristic(Characteristic.Saturation).on('get', this.getSaturation.bind(this));
    service.getCharacteristic(Characteristic.Saturation).on('set', this.setSaturation.bind(this));
    this.LampService= service;
    
    var batteryService= new Service.BatteryService(this.config.name,"Battery");
    ...
    var switchService = new Service.Switch(this.config.name,"Rainbow");
    ...
    switchService.setCharacteristic(Characteristic.Name,this.config.rainbowname);
