...
PlaybulbCandle.prototype.setHue = function(value, callback){
    ...
    var hsv = {H: value, S: this.saturation, V: this.value};
    this.log.info("Set HUE to " + value + ", HSV: " + hsv + ", RGB: " + rgb + ", HEX: " + hex);
...
PlaybulbCandle.prototype.setSaturation = function(value, callback){
    ...
    var hex = this.RGBToHex(rgb.R, rgb.G, rgb.B);
    var hsv = {H: this.hue, S: value, V: this.value};
    this.log.info("Set SAT to " + value + ", HSV: " + hsv + ", RGB: " + rgb + ", HEX: " + hex);
    this.setEffectColor(hex, function(error){
        if(!error){
...
PlaybulbCandle.prototype.setBrightness = function(value, callback){
    ...
    var hex = this.RGBToHex(rgb.R, rgb.G, rgb.B);
    var hsv = {H: this.hue, S: this.saturation, V: value};
    this.log.info("Set VAL to " + value + ", HSV: " + hsv + ", RGB: " + rgb + ", HEX: " + hex);
    this.setEffectColor(hex, function(error){
        if(!error){
            this.value = value;
        }
